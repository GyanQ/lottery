...
public class DateUtils {
     ...
     * @return String 星期几
     */
    public static String getCurrentWeekStr(LocalDate localDate) {
     ...
     */
    public static String dateConversionStr(Date date, String pattern) {
     ...
     * @return LocalDate 日期
     */
    public static Date strParseDate(String date, String pattern) {
