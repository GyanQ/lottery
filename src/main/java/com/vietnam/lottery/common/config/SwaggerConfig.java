...
public class SwaggerConfig {
    ...
    public Docket createWeb() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // 扫描指定包中的swagger注解
                .apis(RequestHandlerSelectors.basePackage("com.vietnam.lottery.content.web"))
    ...
    public Docket createApp() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.withMethodAnnotation(RequestMapping.class))
                // 扫描指定包中的swagger注解
                .apis(RequestHandlerSelectors.basePackage("com.vietnam.lottery.content.app"))
                .paths(PathSelectors.any())
                .build()
                .pathMapping("/");
    }
